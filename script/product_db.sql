...
CREATE TABLE `t_product_info` (
  ...
  `pdtprice` int(11) NOT NULL DEFAULT '0'            COMMENT '产品单价',
...
CREATE TABLE `t_order_info` (
  ...
  `totalprice` int(11) NOT NULL DEFAULT '0'          COMMENT '订单总金额',
  ...
  `back_receiver` varchar(500) DEFAULT ''            COMMENT '退货联系人',
  `back_phone` varchar(2000) DEFAULT ''              COMMENT '退货联系电话',
  `back_express_number` varchar(2000) DEFAULT ''     COMMENT '退货快递单信息，json字符串，格式：["xxxx", "mmmm", "yyyy"]',
...
CREATE TABLE `t_order_detail` (
  ...
  `pdtprice` int(11) NOT NULL DEFAULT '0'            COMMENT '产品单价',
  `totalprice` int(11) NOT NULL DEFAULT '0'          COMMENT '产品总金额，允许自定义金额',
  `status` int(11) NOT NULL DEFAULT '0'              COMMENT '0正常，1删除',
  `extend` varchar(2000) DEFAULT ''                 COMMENT '扩展信息',
  PRIMARY KEY (`id`),
  INDEX index_ref1(ordid),
