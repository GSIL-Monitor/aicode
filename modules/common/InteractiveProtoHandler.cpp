...
void InteractiveProtoHandler::AddDevReq_USR::UnSerializer(const InteractiveMessage &InteractiveMsg)
{
    ...
    m_strAllowDuplicate = InteractiveMsg.reqvalue().adddevreq_usr_value().strallowduplicate();
...
void InteractiveProtoHandler::AddDevReq_USR::Serializer(InteractiveMessage &InteractiveMsg) const
{
    ...
    InteractiveMsg.mutable_reqvalue()->mutable_adddevreq_usr_value()->set_strallowduplicate(m_strAllowDuplicate);
...
void InteractiveProtoHandler::QueryDeviceInfoMultiRsp_USR::UnSerializer(const InteractiveMessage &InteractiveMsg)
{
    ...
    for (int i = 0, sz = InteractiveMsg.rspvalue().querydeviceinfomultirsp_usr_value().devicestatus_size(); i < sz; ++i)
    {
        ...
        devStatus.m_deviceInfo.m_strExtend = InteractiveMsg.rspvalue().querydeviceinfomultirsp_usr_value().devicestatus(i).deviceinfo().strextend();
...
void InteractiveProtoHandler::QueryDeviceInfoMultiRsp_USR::Serializer(InteractiveMessage &InteractiveMsg) const
{
    ...
    for (auto it = m_deviceStatusList.begin(), end = m_deviceStatusList.end(); it != end; ++it)
    {
        ...
        deviceStatus->mutable_deviceinfo()->set_strextend(it->m_deviceInfo.m_strExtend);
