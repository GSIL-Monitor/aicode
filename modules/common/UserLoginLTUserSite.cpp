...
int UserLoginLTUserSite::Login(const string &userName, const string &password)
{
	...
	//postData = "{\"ue\":\"zyQ0MYqFbvkfz/q4m7n7QA==\",\"up\":\"zScxPI+E\",\"token\":\"zw==\",\"ptype\":\"zw==\",\"plang\":\"zQ==\",\"flag\":\"zw==\"}";

	LOG_INFO_RLD("Post data: " << postData);

	//respData = "{\"re\":\"czy\",\"dlist\":\"device list\",\"clist\":\"collect list\"}";

	string respData;
	HttpClient httpClient;
	httpClient.Post(LTUserSiteUrl.c_str(), postData, respData);
