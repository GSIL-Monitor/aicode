...
#define CONFIG_FILE_NAME "management.ini"
#define PROCESS_NAME     "management_cgi"
#define FILE_VERSION     "v[1.0.0] "

void InitLog(ConfigSt& cfg)
{
    std::string strHost = "management_cgi(127.0.0.1)";
...
int main(int argc, char *argv[])
{
    ...
    fcgimgr.SetMsgHandler(HttpMsgHandler::ADD_CLUSER_ACTION, boost::bind(&HttpMsgHandler::AddCluserHandler, &filehdr, _1, _2));
    fcgimgr.SetMsgHandler(HttpMsgHandler::DELETE_CLUSER_ACTION, boost::bind(&HttpMsgHandler::DeleteCluserHandler, &filehdr, _1, _2));
    fcgimgr.SetMsgHandler(HttpMsgHandler::MODIFY_CLUSER_ACTION, boost::bind(&HttpMsgHandler::ModifyCluserHandler, &filehdr, _1, _2));
    fcgimgr.SetMsgHandler(HttpMsgHandler::QUERY_CLUSER_INFO_ACTION, boost::bind(&HttpMsgHandler::QueryCluserInfoHandler, &filehdr, _1, _2));
    fcgimgr.SetMsgHandler(HttpMsgHandler::CLUSER_SHAKEHAND_ACTION, boost::bind(&HttpMsgHandler::CluserShakehandHandler, &filehdr, _1, _2));
    fcgimgr.SetMsgHandler(HttpMsgHandler::QUERY_ALL_CLUSER_ACTION, boost::bind(&HttpMsgHandler::QueryAllCluserHandler, &filehdr, _1, _2));
    fcgimgr.SetMsgHandler(HttpMsgHandler::QUERY_CLUSER_DEVICE_ACTION, boost::bind(&HttpMsgHandler::QueryCluserDeviceHandler, &filehdr, _1, _2));
    fcgimgr.SetMsgHandler(HttpMsgHandler::QUERY_CLUSER_USER_ACTION, boost::bind(&HttpMsgHandler::QueryCluserUserHandler, &filehdr, _1, _2));
