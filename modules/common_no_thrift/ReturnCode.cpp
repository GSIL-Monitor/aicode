...
const int ReturnInfo::DEVICE_ADDED_BY_CURRENT_USER_TYPE = 1090; //当前用户已添加此设备并且类型不同
...
const int ReturnInfo::DEVICE_LONGIN_REFUSED = 3320;          //设备登陆被拒绝
...
const int ReturnInfo::PRODUCT_ALREADY_USED = 3330; //产品已经使用
